...
import com.cs.fft.core.ComplexNumberArray;
import com.cs.fft.core.Fourier;
...
public class FFT {
    public static void main(String[] args) {
        ...
        //输出最大幅值处的频率
        System.out.println("快速傅里叶变换最大幅值处的频率：" + fftAnalyzer.getFrequencyAtMaxAmplitude(cna));
        //快速傅里叶逆变换
        float[] oData = fft.ifft(cna);
        //输出结果
		System.out.println("快速傅里叶逆变换结果：");
        for (float o : oData) {
            System.out.print(o + ", ");
        }
